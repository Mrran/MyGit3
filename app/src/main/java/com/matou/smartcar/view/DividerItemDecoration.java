...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean isDrawLastOne = false;
...
//            }
            if (mPaint != null) {
                if (i != childCount - 1) {
                    ...
                    if (isDrawLastOne) c.drawRect(left, top, right, bottom, mPaint);
                }
            }
        }
    }
...
//            }
    ...
    public void setDrawLastOne(boolean drawLastOne) {
        isDrawLastOne = drawLastOne;
    }
}
